...
image:MessagingGatewaySolution.gif[]
...
image:MessagingMapperClassDiagram.gif[]
...
image:TransactionalClientSolution.gif[]
...
image:MessageSelectorSolution.gif[]
...
image:DurableSubscriptionSolution.gif[]
...
image:MessagingAdapterSolution.gif[]
