...
image:PointToPointSolution.gif[]
...
image:PublishSubscribeSolution.gif[]
...
image:InvalidMessageSolution.gif[]
...
image:DeadLetterChannelSolution.gif[]
...
image:GuaranteedMessagingSolution.gif[]
...
image:ChannelAdapterSolution.gif[]

Element pośredniczący pomiędzy aplikacją a szyną czy MOM

=== most 

image:MessagingBridge.gif[]
